...
///
module house_renting::royalty_rule {
    use sui::sui::SUI;
    ...
    use house_renting::house_renting::{House};
    ...
    public fun add(
        policy: &mut TransferPolicy<House>,
        cap: &TransferPolicyCap<House>,
        amount_bp: u16,
        min_amount: u64
    ) {
    ...
    public fun pay(
        policy: &mut TransferPolicy<House>,
        request: &mut TransferRequest<House>,
        payment: Coin<SUI>
    ) {
    ...
    public fun fee_amount(policy: &TransferPolicy<House>, paid: u64): u64 {
